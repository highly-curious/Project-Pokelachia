...
OverworldMonIconColors::
	...
	iconpal BROWN, RED ; ROGGENROLA
	iconpal BROWN, RED ; BOLDORE
	iconpal BROWN, RED ; GIGALITH
	...
	iconpal PINK, TEAL ; COTTONEE
	iconpal BROWN, TEAL ; WHIMSICOTT
	...
	iconpal BROWN, GREEN ; POLTEGEIST
